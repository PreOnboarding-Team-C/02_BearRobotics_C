...
class UploadAll:
    ...
    def upload_restaurants(self, csvs):
        groups = Group.objects.get(name='CJ푸드빌')
    ...
    def upload_menu(self):
        menus = [
            Menu(
                restaurant = Restaurant.objects.get(id=21),
                name = "갈비비빔밥",
                price = 15000,
            ),
            Menu(
            ...
            Menu(
                restaurant = Restaurant.objects.get(id=22),
                name = "버거",
                price = 10000,
            ),
            Menu(
            ...
            Menu(
                restaurant = Restaurant.objects.get(id=31),
                name = "수제주먹밥",
                price = 2500,
            ),
            Menu(
            ...
            Menu(
                restaurant = Restaurant.objects.get(id=32),
                name = "식빵",
                price = 3000,
            ),
            Menu(
    ...
    def upload_pos(self, csvs):
        pos = [
            Pos(
                created_datetime = rows.get('timestamp'),
                restaurant = Restaurant.objects.get(id=rows.get('restaurant')),
                number_of_party = rows.get('number_of_party'),
